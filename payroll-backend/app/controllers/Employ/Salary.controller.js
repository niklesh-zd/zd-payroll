...
class Salary {
    ...
    async salary_(req, res, next){
        ...
        if (Salary_Modal.length != 0){
            ...
            if (moment(empinfo_modal.base_salary_list.pop().effective_date).month() + 1 != Number(req.query.month)){
                ...
                var salary_emp = Number(empinfo_modal.base_salary_list.pop().salary_)
            ...
            else if (moment(empinfo_modal.base_salary_list.pop().effective_date).month() + 1 == Number(req.query.month) && empinfo_modal.base_salary_list.length == 1){
                const holiday = await HolidayModal.find({
                    holiday_date: { 
                        $gte: empinfo_modal.base_salary_list.pop().effective_date, 
                        $lte: req.query.year + "-" + req.query.month + "-" + month_array[Number(req.query.month) - 1] 
                    }
                });
                ...
                var working_days = Number(month_array[Number(req.query.month) - 1]) - holiday.length - moment(empinfo_modal.base_salary_list.pop().effective_date).date() + 1
                var salary_emp = Number(empinfo_modal.base_salary_list.pop().salary_)
                var balance_days = 1 - leave_taken
                var present_days = working_days - leave_taken
                var total_paid_days = present_days + 1
            ...
            //         holiday_date: { 
            //             $gte: req.query.year + "-" + req.query.month + '-01', 
            //             $lt: empinfo_modal.base_salary_list.pop().effective_date
            //         }
            //     });
            ...
            //     var working_days_1 = moment(empinfo_modal.base_salary_list.pop().effective_date).date() - 1 - holiday_1.length
            //     var working_days_2 = Number(month_array[Number(req.query.month) - 1]) - holiday_2.length - moment(empinfo_modal.base_salary_list.pop().effective_date).date() + 1
